	...
	return (
		<>
			<div
				...
				style={{
					backgroundImage:
						"linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('/jelo_bg-600.png')",
				}}
			>
				{/* Hero Section */}

				<div className="w-full text-center py-16 px-4 bg-gradient-to-r from-black/10 to-black/10 backdrop-blur-[2px]">
					<h1 className="text-9xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r">
						Jelo
					</h1>
...
export default SuiFungibleCoin;
